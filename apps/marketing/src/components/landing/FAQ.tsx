...
const FAQ_ITEMS = [
  ...
  {
    q: 'מה נכלל באוטומציות ובאינטגרציות?',
    a: 'אוטומציות מריצות פולו-אפ, תיאום תורים והתראות לפי מה שקורה במשפך. אינטגרציות מחברות Meta, וואטסאפ רשמי, יומן וייבוא — כדי שכל ליד ייכנס לתהליך בלי העתקה ידנית.',
  },
  {
